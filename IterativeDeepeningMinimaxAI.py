...
class IterativeDeepeningMinimaxAI():
    ...
    def __init__(self, depth, is_white):
        ...
        self.best_move = [] # list of best moves to visualize depth changes

    def choose_move(self, board):

        for num in range(self.depth):
            self.minimax(board, num + 1) # call minimax for each depth
            minimum_score = None
            ...
            if self.next_move is None:
                ...
                self.best_move.append(self.next_move)
                print("Iterative Deepening BEST: ", self.best_move)
                print("Itereative Deepening current DEPTH: ", num + 1)
    ...
    def minimax(self, board, max_depth):
        ...
        if max_depth == 0:  # if depth is reached just evaluate the board as score
            ...
            for move in moves:
                ...
                board.push(move)  # add the first move
